...
public class accesorioGato {
    ...
    private void armar(){
        ...
        a.setIcon(new ImageIcon("src\\layout\\sources\\26.jpg"));
        

        b.setIcon(new ImageIcon("src\\layout\\sources\\27.jpg"));

        
        c.setIcon(new ImageIcon("src\\layout\\sources\\28.jpg"));
       

       d.setIcon(new ImageIcon("src\\layout\\sources\\29.jpg"));
     
      
        e.setIcon(new ImageIcon("src\\layout\\sources\\30.jpg"));
