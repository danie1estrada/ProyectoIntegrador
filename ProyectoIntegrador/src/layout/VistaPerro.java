...
public class VistaPerro {
    ...
    private void armar(){
        ...
        alimento.setIcon(new ImageIcon("src\\layout\\sources\\comida.jpg"));
        alimento.addMouseListener(m);

        accesorio.setIcon(new ImageIcon("src\\layout\\sources\\accesorio.jpg"));
    ...
    private class mensaje extends MouseAdapter{
        ...
        public void mouseEntered(MouseEvent me){
            if(me.getSource()== alimento){
                mensaje = "alimento para todas las edades";
                alimento.setToolTipText(mensaje);
            }
            if(me.getSource()==accesorio){
                mensaje = "variedad de accesorios para tu cachorrito";
