...
public class VistaGato {
    ...
    private void armar(){
        ...
        alimento.setIcon(new ImageIcon("src\\layout\\sources\\comidaGato.jpg"));
        alimento.addMouseListener(m);

        accesorio.setIcon(new ImageIcon("src\\layout\\sources\\accesorioGato.png"));
    ...
    private class mensaje extends MouseAdapter{
        ...
        public void mouseEntered(MouseEvent me){
            if(me.getSource()== alimento){
                mensaje = "alimento para tu minino";
                alimento.setToolTipText(mensaje);
            }
            if(me.getSource()==accesorio){
                mensaje = "variedad de accesorios para que tu gato se divierta";
