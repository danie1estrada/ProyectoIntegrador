...
public class accesorioAve {
    ...
    private void armar(){
        ...
        a.setIcon(new ImageIcon("src\\layout\\sources\\16.jpg"));
        

        b.setIcon(new ImageIcon("src\\layout\\sources\\17.jpg"));

        
        c.setIcon(new ImageIcon("src\\layout\\sources\\18.jpg"));
       

       d.setIcon(new ImageIcon("src\\layout\\sources\\19.jpg"));
     
      
        e.setIcon(new ImageIcon("src\\layout\\sources\\20.jpg"));
