...
public class accesorioPerro {
    ...
    private void armar(){
        ...
        a.setIcon(new ImageIcon("src\\layout\\sources\\21.jpg"));
        

        b.setIcon(new ImageIcon("src\\layout\\sources\\22.jpg"));

        
        c.setIcon(new ImageIcon("src\\layout\\sources\\23.jpg"));
       

       d.setIcon(new ImageIcon("src\\layout\\sources\\24.jpg"));
     
      
        e.setIcon(new ImageIcon("src\\layout\\sources\\25.jpg"));
